...
Route::middleware(['auth', 'cors'])->group(function () {
    ...
    Route::prefix('vends')->group(function () {
        ...
        Route::get('/{vend}/freezer-controls/{command}/log', [FreezerControlController::class, 'log'])
            ...
            ->middleware('can:read machine-settings');
        Route::get('/{vend}/freezer-controls/{command}/attachment', [FreezerControlController::class, 'attachment'])
            ->name('vends.freezer-controls.attachment')->middleware('can:read machine-settings');
...
Route::middleware(['auth', 'cors'])->prefix('card-settlements')->group(function () {
    ...
    Route::get('/{id}/download-converted', [CardSettlementController::class, 'downloadConverted'])->name('card-settlements.download-converted');
    ...
    Route::post('/{id}/bind-unbound', [CardSettlementController::class, 'bindUnbound'])->name('card-settlements.bind-unbound');
