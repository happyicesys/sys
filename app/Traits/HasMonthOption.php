...
trait HasMonthOption{
  ...
  public function getReportDateOptions()
  {
    ...
    $options = [
      ...
      Carbon::today()->subWeeks(2)->startOfWeek()->toDateString().','.Carbon::today()->subWeeks(2)->endOfWeek()->toDateString() => 'Two Weeks Ago',
      ...
      Carbon::today()->subMonths(2)->startOfMonth()->toDateString().','.Carbon::today()->subMonths(2)->endOfMonth()->toDateString() => '2 Months Ago',
      Carbon::today()->subMonths(2)->startOfMonth()->toDateString().','.Carbon::today()->subMonths(1)->endOfMonth()->toDateString() => 'Last 2 Months',
      Carbon::today()->subMonths(3)->startOfMonth()->toDateString().','.Carbon::today()->subMonths(3)->endOfMonth()->toDateString() => '3 Months Ago',
      Carbon::today()->subMonths(3)->startOfMonth()->toDateString().','.Carbon::today()->subMonths(1)->endOfMonth()->toDateString() => 'Last 3 Months',
