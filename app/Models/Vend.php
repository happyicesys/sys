...
class Vend extends Model
{
    ...
    protected $casts = [
        ...
        // Cumulative data-usage counters (APK v303 "Data*"), same promotion.
        'internet_data_kb' => 'integer',
        'internet_data_mobile_kb' => 'integer',
        'internet_data_app_kb' => 'integer',
        'internet_data_days' => 'integer',
        'internet_data_updated_at' => 'datetime',
    ...
    protected $fillable = [
        ...
        'internet_updated_at',
        'internet_data_kb',
        'internet_data_mobile_kb',
        'internet_data_app_kb',
        'internet_data_days',
    ...
    {
        // withTrashed(): VendPrefix soft-deletes, and this machine's
