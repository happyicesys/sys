...
class SimulatePsTermTotals extends Command
{
    protected $signature = 'summary:simulate-ps-term
        ...
        {--operators=HIPL,HIMD,LEA,HIESG,UL-ST,XO,MSW : Restrict to these operators (comma-separated IDs or codes). Default mirrors the Summary page default operator chips (OperatorScope::DEFAULT_FILTER_CODES). Pass "all" for every operator.}';
