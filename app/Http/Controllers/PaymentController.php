...
class PaymentController extends Controller
{
    ...
    public function createPaymentGatewayLog(Request $request, $company)
    {
        ...
        // Midtrans refund / partial_refund webhooks take the same path (2026-09-02):
        // the recorder is gateway-agnostic — log → REFUND, linked sale is_refunded,
        ...
        if ($externalRefundSource && $status === PaymentGatewayLog::STATUS_REFUND) {
            app(\App\Services\Refund\OmiseRefundRecorder::class)
                ->record($updatedPaymentGatewayLog, $input, $externalRefundSource);
        }
