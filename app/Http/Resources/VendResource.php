...
class VendResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'modemType' => isset($this->modem_type_id) ? ModemTypeResource::make($this->whenLoaded('modem_type_id')) : null,
            'modem_type_id' => isset($this->modem_type_id) ? $this->modem_type_id : null,
            'modemUnit' => isset($this->modem_unit_id) ? ModemUnitResource::make($this->whenLoaded('modem_unit_id')) : null,
