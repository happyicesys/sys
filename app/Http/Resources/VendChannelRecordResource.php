...
class VendChannelRecordResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'after_data_created_at_formatted' => isset($this->after_data_created_at) ? $this->after_data_created_at->format('ymd h:ia') : '',
            'after_label' => $this->after_label,
            'before_data_json' => $this->before_data_json,
            'before_data_created_at' => $this->before_data_created_at,
            'before_date_created_at_formatted' => isset($this->before_data_created_at) ? $this->before_data_created_at->format('ymd h:ia') : '',
            'before_label' => $this->before_label,
            'stage_data_json' => $this->stage_data_json,
            'stage_data_created_at' => $this->stage_data_created_at,
            'stage_date_created_at_formatted' => isset($this->stage_data_created_at) ? $this->stage_data_created_at->format('ymd h:ia') : '',
