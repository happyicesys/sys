...
class CreateVendTransaction implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $vendTransaction = VendTransaction::create([
            ...
            'is_multiple' => isset($input['transf_info']) and $input['transf_info'] ? true : false,
            'is_payment_received' => $isPaymentReceived,
            'items_json' => isset($input['transf_info']) and $input['transf_info'] ? collect($input['transf_info']) : null,
