          ...
          <div class="flex flex-col">
            <div class="-my-2 -mx-4 overflow-x-auto sm:-mx-3 lg:-mx-5">
              <div class="inline-block min-w-full py-2 align-middle md:px-3 lg:px-6">
                <div class="overflow-scroll max-h-[700px] md:max-h-[800px] shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
                  <!-- mobile view -->
                      ...
                      <tr v-for="(channel, channelIndex) in channels" :key="channel.id" :class="channelIndex % 2 === 0 ? undefined : 'bg-gray-50'">
                        ...
                        <td class="whitespace py-5 pl-4 pr-3 text-sm font-bold sm:pl-6 text-center text-gray-900">
                          <div class="flex flex-col space-y-1 justify-center">
                            ...
                            <div class="flex space-x-1 items-center justify-center" :class="[opsJobItem.status == 2 ? 'text-blue-700' : 'text-gray-900']" v-if="opsJobItem.status >= 2">
