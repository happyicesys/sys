        ...
        <dl class="mt-2 grid grid-cols-1 gap-5 sm:grid-cols-3">
            <div class="overflow-hidden rounded-lg bg-gray-100 mt-1 px-4 py-3 shadow">
                ...
                <dd class="mt-1 text-2xl font-semibold tracking-normal text-gray-900">
                    {{(totals['total_amount']/ (Math.pow(10, operatorCountry.currency_exponent))).toLocaleString(undefined, {minimumFractionDigits: (operatorCountry.is_currency_exponent_hidden ? 0 : operatorCountry.currency_exponent), maximumFractionDigits: (operatorCountry.is_currency_exponent_hidden ? 0 : operatorCountry.currency_exponent)})}}
                </dd>
            </div>
            <div class="overflow-hidden rounded-lg bg-gray-100 mt-1 px-4 py-3 shadow">
                        ...
                        <li class="flex py-1 px-3 space-x-2" v-for="deliveryPlatformOrderItem in deliveryPlatformOrder.deliveryPlatformOrderItems">
                          ...
                          <!-- <div class="flex self-center">
                            <a :href="deliveryPlatformOrderItem.deliveryProductMappingItem.product.thumbnail.full_url" target="_blank" v-if="deliveryPlatformOrderItem.deliveryProductMappingItem.product.thumbnail">
                              <img class="h-24 w-24 md:h-16 md:w-20 rounded-lg object-contain bg-white border border-gray-200 p-1" :src="deliveryPlatformOrderItem.deliveryProductMappingItem.product.thumbnail.full_url" alt="" />
                            </a>
                          </div> -->
...
function getCampaignSettingsName(deliveryPlatformOrder, campaignID) {
  return deliveryPlatformOrder.deliveryProductMappingVend && deliveryPlatformOrder.deliveryProductMappingVend.deliveryPlatformCampaignItemVends.find((vend) => vend.platform_ref_id == campaignID) ? deliveryPlatformOrder.deliveryProductMappingVend.deliveryPlatformCampaignItemVends.find((vend) => vend.platform_ref_id == campaignID).deliveryPlatformCampaignItem.settings_name : ''
}
