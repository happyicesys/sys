        ...
        <div class="flex flex-col space-y-3 md:flex-row md:space-y-0 justify-between mt-5">
          <div class="mt-3">
            <div class="flex flex-col space-y-1 md:flex-row md:space-y-0 md:space-x-1">
              ...
              <Button class="inline-flex space-x-1 items-center rounded-md border bg-white px-8 py-3 md:px-5 text-sm font-medium leading-4 text-gray-700 shadow-sm hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
              @click="resetFilters()"
              >
                    ...
                    <tr v-for="(unit, unitIndex) in cardTerminalUnits.data" :key="unit.id" class="divide-x divide-y-2 divide-gray-300 odd:bg-white even:bg-gray-100">
                      ...
                      <TableData :currentIndex="unitIndex" :totalLength="cardTerminalUnits.length" inputClass="text-left">
                        <span v-if="unit.current_vend_code" class="flex flex-col">
                          <a class="text-blue-700 underline" target="_blank" :href="'/settings?code=' + unit.current_vend_code">
