                      ...
                      <TableData :currentIndex="locationTypeIndex" :totalLength="locationTypes.length" inputClass="text-center">
                        <div class="flex justify-center space-x-1">
                          <Button
                            ...
                            @click="onEditClicked(locationType)"
                          >
...
function onDeleteClicked(locationType) {
  const approval = confirm('Are you sure to delete ' + locationType.name + '?');
  if (!approval) {
      return;
  }
