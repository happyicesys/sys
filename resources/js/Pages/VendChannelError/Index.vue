            ...
            <table class="min-w-full border-separate" style="border-spacing: 0">
                <thead class="bg-gray-100">
                  ...
                  <tbody class="bg-white">
                    <tr v-for="(vendChannelError, vendChannelErrorIndex) in vendChannelErrors.data" :key="vendChannelError.id" class="divide-x divide-y-2 divide-gray-300 odd:bg-white even:bg-gray-100">
