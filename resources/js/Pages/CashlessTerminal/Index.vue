    ...
    <div class="m-2 sm:mx-5 sm:my-3 px-1 sm:px-2 lg:px-3">
      <div class="-mx-4 sm:-mx-6 lg:-mx-8 bg-white rounded-md border my-3 px-3 md:px-3 py-3 ">
        ...
        <div class="grid grid-cols-1 md:grid-cols-5 gap-2">
          <SearchInput placeholderStr="Terminal ID" v-model="filters.code">
            Terminal ID
          </SearchInput>
          <div>
        ...
        <div class="flex flex-col space-y-3 md:flex-row md:space-y-0 justify-between mt-5">
          ...
          <div class="flex flex-col space-y-2">
              <p class="text-sm text-gray-700 leading-5 flex space-x-1">
                  <span>Showing</span>
                  <span class="font-medium">{{ cashlessTerminals.meta.from ?? 0 }}</span>
                  <span>to</span>
                  <span class="font-medium">{{ cashlessTerminals.meta.to ?? 0 }}</span>
                  <span>of</span>
                  <span class="font-medium">{{ cashlessTerminals.meta.total }}</span>
                  <span>results</span>
              </p>
              <MultiSelect
      ...
      <div class="mt-6 flex flex-col">
       <div class="-my-2 -mx-4 sm:-mx-6 lg:-mx-8">
          <div class="shadow-sm ring-1 ring-black ring-opacity-5 overflow-scroll">
            <table class="min-w-full border-separate" style="border-spacing: 0">
                <thead class="bg-gray-100">
                  <tr class="divide-x divide-gray-200">
                    ...
                    <TableHeadSort modelName="cashless_provider_id" :sortKey="filters.sortKey" :sortBy="filters.sortBy" @sort-table="sortTable('cashless_provider_id')">
                      Provider
                    </TableHeadSort>
                    <TableHead>
                    </TableHead>
                  ...
                  <tbody class="bg-white">
                    <tr v-for="(cashlessTerminal, telcoIndex) in cashlessTerminals.data" :key="cashlessTerminal.id" class="divide-x divide-y-2 divide-gray-300 odd:bg-white even:bg-gray-100">
                      ...
                      <TableData :currentIndex="telcoIndex" :totalLength="cashlessTerminals.length" inputClass="text-center">
                        <div class="flex justify-center space-x-1">
                          <Button
                            ...
                            @click="onEditClicked(cashlessTerminal)"
                          >
                          ...
                          <Button
                            ...
                            @click="onDeleteClicked(cashlessTerminal)"
                          >
                ...
                <tr v-if="!cashlessTerminals.data.length">
            ...
            <Paginator v-if="cashlessTerminals.data.length" :links="cashlessTerminals.links" :meta="cashlessTerminals.meta"></Paginator>
          </div>
      </div>
    </div>
  </div>
