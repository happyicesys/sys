        ...
        <div class="flex flex-col space-y-3 md:flex-row md:space-y-0 justify-between mt-5">
          ...
          <div class="flex flex-col space-y-2">
              <p class="text-sm text-gray-700 leading-5 flex space-x-1">
                  <span>Showing</span>
                  <span class="font-medium">{{ permissions.meta.from ?? 0 }}</span>
                  <span>to</span>
                  <span class="font-medium">{{ permissions.meta.to ?? 0 }}</span>
                  <span>of</span>
                  <span class="font-medium">{{ permissions.meta.total }}</span>
                  <span>results</span>
              </p>
              <MultiSelect
      ...
      <div class="mt-6 flex flex-col">
       <div class="-my-2 -mx-4 sm:-mx-6 lg:-mx-8">
          <div class="shadow-sm ring-1 ring-black ring-opacity-5 overflow-scroll">
                      ...
                      <TableData :currentIndex="paymentTermIndex" :totalLength="permissions.length" inputClass="text-center">
                        <div class="flex justify-center space-x-1">
                          <Button
                            ...
                            @click="onEditClicked(permission)"
                          >
                          ...
                          <Button
                            ...
                            @click="onDeleteClicked(permission)"
                          >
            ...
            <Paginator v-if="permissions.data.length" :links="permissions.links" :meta="permissions.meta"></Paginator>
          </div>
      </div>
    </div>
  </div>
...
import Form from '@/Pages/Permission/Form.vue';
...
function onDeleteClicked(permission) {
  const approval = confirm('Are you sure to delete ' + permission.name + '?');
  if (!approval) {
      return;
  }
