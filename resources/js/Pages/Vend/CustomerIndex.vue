					...
					<TableData :currentIndex="vendIndex" :totalLength="vends.length" inputClass="text-left">
						<div class="flex flex-col space-y-1">
							...
							<span v-if="vend.person_id" class="flex flex-col">
								...
								<span v-if="vend && vend.vend && vend.vend.deliveryProductMappingVends" v-for="(deliveryProductMappingVend, index) in vend.vend.deliveryProductMappingVends">
									<div
							...
							<div class="flex flex-col space-y-1 pl-2 text-center">
								...
								<span>
									<div
										class="text-gray-800"
									>
										FL: {{ operatorCountry.currency_symbol }}{{ vend.total_full_load_amount ? vend.total_full_load_amount.toLocaleString(undefined, {minimumFractionDigits: 2, maximumFractionDigits: 2}) : 0 }}
									</div>
								</span>
							</div>
						</div>
