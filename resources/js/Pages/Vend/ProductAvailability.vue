              ...
              <table class="min-w-full divide-y divide-gray-300">
                <thead class="bg-gray-100 sticky top-0 z-10">
                  ...
                  <tr>
                    ...
                    <!-- Last incoming: CMS's last Stock In batch, or the ledger's last incoming movement. Sorted by date. -->
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                  <tr v-for="(product, productIndex) in products.data" :key="product.id" class="hover:bg-gray-50">
                    ...
                    <td class="p-1 sm:p-3 text-center border-r border-gray-300 leading-tight">
                      <div class="text-sm sm:text-lg font-bold" :class="[product.is_available ? 'text-gray-600' : 'text-gray-400']">
