...
<template>
  <Head title="Machine Snapshot" />

  <BreezeAuthenticatedLayout>
      <template #header>
          <h2 class="font-semibold text-xl text-gray-800 leading-tight">
              Machine Monthly Snapshot
          </h2>
          <p class="text-xs">
            (Machine stats will be captured on the last day of every month)
          </p>
      </template>
                          ...
                          <TableData :currentIndex="vendIndex" :totalLength="vendSnapshots.length" inputClass="text-center">
                              <div class="flex flex-col space-y-1">
                                  <div
                                      ...
                                      v-if="vendSnapshot.parameterJson && 'Sensor' in vendSnapshot.parameterJson"
                                  >
                                  ...
                                  <div
                                      class="inline-flex justify-center items-center rounded px-1.5 py-0.5 text-xs font-medium border min-w-full"
                                      :class="[vendSnapshot.parameterJson['CoinCnt'] > COIN_FLOAT_LOW_THRESHOLD ? 'bg-green-200' : 'bg-red-200']"
