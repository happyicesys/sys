                ...
                <thead class="bg-gray-100">
                  ...
                  <tbody class="bg-white">
                    <tr v-for="(locationType, locationTypeIndex) in locationTypes.data" :key="locationType.id" class="divide-x divide-gray-200">
                      ...
                      <TableData colspan="2" :currentIndex="locationTypeIndex" :totalLength="locationTypes.length" inputClass="text-left">
                        {{ locationType.name }}
                      </TableData>
                      <TableData :currentIndex="locationTypeIndex" :totalLength="locationTypes.length" inputClass="text-right">
                        {{ locationType.this_month_count.toLocaleString(undefined, {minimumFractionDigits: 0, maximumFractionDigits: 0}) }}
                      </TableData>
                      <TableData :currentIndex="locationTypeIndex" :totalLength="locationTypes.length" inputClass="text-right">
                      ...
                      <TableData :currentIndex="locationTypeIndex" :totalLength="locationTypes.length" inputClass="text-right">
                        {{ locationType.last_month_count.toLocaleString(undefined, {minimumFractionDigits: 0, maximumFractionDigits: 0}) }}
                      </TableData>
                      <TableData :currentIndex="locationTypeIndex" :totalLength="locationTypes.length" inputClass="text-right">
                      ...
                      <TableData :currentIndex="locationTypeIndex" :totalLength="locationTypes.length" inputClass="text-right">
                        {{ locationType.last_two_month_count.toLocaleString(undefined, {minimumFractionDigits: 0, maximumFractionDigits: 0}) }}
                      </TableData>
                      <TableData :currentIndex="locationTypeIndex" :totalLength="locationTypes.length" inputClass="text-right">
...
function onSearchFilterUpdated() {
  router.get('/reports/gp/location-type', {
      ...filters.value,
...
function onExportExcelClicked() {
    ...
    axios({
        method: 'get',
        url: '/reports/gp/location-type/excel',
        params: {
            ...filters.value,
            categories: filters.value.categories.map((category) => { return category.id }),
            categoryGroups: filters.value.categoryGroups.map((categoryGroup) => { return categoryGroup.id }),
