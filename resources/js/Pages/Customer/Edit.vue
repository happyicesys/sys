                  ...
                  <div class="sm:col-span-3">
                    <div class="flex items-end gap-2">
                      ...
                      <!-- "Pull from CMS" — on-demand, ONE-WAY CMS → form fill. Fetches
                           ...
                           saved until Update is pressed; nothing is pushed to CMS. -->
                      <Button
                        type="button"
...
import { ArrowDownTrayIcon, ArrowPathIcon, ArrowTopRightOnSquareIcon, ArrowUturnLeftIcon, CheckCircleIcon, ClockIcon, LockClosedIcon, LockOpenIcon, ExclamationCircleIcon, MinusCircleIcon, StopCircleIcon, TrashIcon, XCircleIcon } from '@heroicons/vue/20/solid';
...
// form fields only; the user reviews and presses Update to persist. Nothing
// is ever pushed back to CMS from here (CMS is the source of truth — edit
// there, then re-pull). Mirrors Customer/Create.vue.
...
async function pullFromCms() {
  ...
  try {
    ...
    cmsPullMessage.value = 'Pulled from CMS — review the fields below, then Update.';
  } catch (e) {
    cmsPullOk.value = false;
