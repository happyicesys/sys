...
echo "Found " . $customers->count() . " customers for '$customerName'.\n";
...
if ($customers->isEmpty()) {
    ...
    $monthly = App\Models\VendRecord::whereIn('customer_id', $customers)
    ...
    $daily = App\Models\VendRecord::whereIn('customer_id', $customers)
        ->whereIn('year', [2024, 2025])
        ->where('month', 12)
